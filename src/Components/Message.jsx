...
const Message = () => {
  ...
  return (
    ...
    // custom={ind}
    >
        <div className="flex  flex-wrap items-center justify-end gap-10 md:gap-20 pc:mt-28 pc:w-7/12 mobile:w-full  pc:ml-20 pc:h-[400px] mobile:h-full" style={{marginBottom:'200px', marginTop:'100px'}}>
