...
//This code is for cards stacking , appears from left to right 
// const PCVariants={
...
//          }}
//          custom={5*(index)}
//          className='absolute z-20 flex justify-center items-center rounded-md border-8 overflow-clip border-gray-600' style={{width:"540px", height:"408px" , z:(index-1)}}>
